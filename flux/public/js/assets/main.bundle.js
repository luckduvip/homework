...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_index2.default, null), document.getElementById("test"));
...
/***/ function(module, exports, __webpack_require__) {
	   ...
	   */
			value: function render() {
				return _react2.default.createElement(
					"a",
					{ href: "javascript:;", className: "common_select_item" },
	...
	var SelectList = function (_React$Component) {
		...
		function SelectList(props) {
			...
			var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(SelectList).call(this, props));
		...
		_createClass(SelectList, [{
			...
			value: function render() {
				return _react2.default.createElement(
					"div",
					{ className: "common_select_list" },
					this.props.list.map(function (item) {
						return _react2.default.createElement(SelectItem, { key: item.id, item: item });
					})
				);
			}
		}]);
	...
	var SelectBox = function (_React$Component2) {
		_inherits(SelectBox, _React$Component2);

		function SelectBox(props) {
			_classCallCheck(this, SelectBox);

			var _this3 = _possibleConstructorReturn(this, Object.getPrototypeOf(SelectBox).call(this, props));

			_this3.state = _this3._getState();
			return _this3;
		}
		...
		_createClass(SelectBox, [{
			...
			value: function _getState() {
				return;
				{
					list: [{ id: "0", text: "item 0" }, { id: "1", text: "item 1" }, { id: "2", text: "item 2" }, { id: "3", text: "item 3" }, { id: "4", text: "item 4" }];
				}
			}
		}, {
			key: "render",
			value: function render() {
				return _react2.default.createElement(
					"div",
					{ className: "common_select_box" },
					_react2.default.createElement(SelectList, { list: this.state.list })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "* {\n  *zoom: 1; }\n  :before, :after {\n    content: \"\";\n    display: table;\n    font: 0/0 a; }\n  :after {\n    clear: both; }\n\n* {\n  margin: 0;\n  padding: 0;\n  -webkit-transition: translate 0.5s linear; }\n", ""]);
